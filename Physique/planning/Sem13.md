...
* (optionnel) [L'essentiel, mouvement de particules chargées dans les champs électrique et magnétique](https://youtu.be/EheHYstRxmE)
* (optionnel) [DiaN, accélérer une charge dans une différence de potentiel](https://youtu.be/tFlnrm1ob4Y)
* (optionnel) [DiaN, obtention rapide du rayon de la trajectoire d'une charge q dans un champ B uniforme](https://youtu.be/OOdIYcvKI6k)
...
* (optionnel) L'essentiel, mouvement de particules chargées dans les champs électrique et magnétique 
...
* (optionnel) DiaN, accélérer une charge dans une différence de potentiel 
...
* (optionnel) DiaN, obtention rapide du rayon de la trajectoire d'une charge q dans un champ B uniforme 
